...
#define CONFIG_ENV_SECT_SIZE	(256*1024)		/* smallest erase sector size */
...
#define CONFIG_SF_SHOW_PROGRESS		/* Display status while erasing and writting */
...
#define HIDE_CONFIG_SYS_EEPROM_PAGE_WRITE_BITS	4	/* 16-Byte Write Mode */
#define HIDE_CONFIG_SYS_EEPROM_PAGE_WRITE_DELAY_MS	10	/* 10ms of delay */
...
#define CONFIG_SH_SDHI_ADDR            0xE804E000
#define CONFIG_MMC_SH_SDHI_NR_CHANNEL  1
#define CONFIG_SH_SDHI_FREQ            66666666
#define CONFIG_SH_MMCIF_ADDR           0xE804C800
#define CONFIG_SH_MMCIF_CLK		66666666
